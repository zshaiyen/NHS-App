        ...
        for cy in class_year_rv:
            ...
            for user_cat in users_cat_rv:
                ...
                if carryover_hours > 0:
                    app_lib.add_verification_log(user_cat['name'], date.today(), carryover_hours, 'Surplus' + str(user_cat['name']), None, None, None, None, None, org['organization_id'], user_cat['email'], user_cat['full_name'], None, None, None)
                if carryover_hours < 0:
                    app_lib.add_verification_log(user_cat['name'], date.today(), carryover_hours, 'Deficit' + str(user_cat['name']), None, None, None, None, None, org['organization_id'], user_cat['email'], user_cat['full_name'], None, None, None)
